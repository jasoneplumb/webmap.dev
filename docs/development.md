...
- **Bundle size** — `npm run size` enforces a 150 kB gzipped budget on `dist/assets/index-*.js`. Measured 126.39 kB gzipped at v0.50.0 (`439caf4`, 2026-09-13); the budget is a ceiling, not the measurement.
